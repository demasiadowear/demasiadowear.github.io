 ...
 * 
 * Versione corretta: risolto bug di numerazione tra immagini centrali e miniature
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createSlide(collection, index) {
        ...
        slide.setAttribute('data-index', index); // Aggiunto attributo per tracciare l'indice
        ...
        // Aggiungere numero immagine all'overlay
        const slideNumber = document.createElement('div');
        slideNumber.className = 'lookbook-slide-number';
        slideNumber.textContent = index; // Usa lo stesso indice per slide e miniatura
    ...
    function createNavigation() {
        ...
        for (let i = 0; i < totalSlides; i++) {
            ...
            // Ottieni l'indice dalla slide corrispondente
            const slideIndex = lookbookSlider.children[i].getAttribute('data-index');
            
            // Aggiungi numero all'indicatore
            const indicatorNumber = document.createElement('span');
            indicatorNumber.className = 'indicator-number';
            indicatorNumber.textContent = slideIndex;
            dot.appendChild(indicatorNumber);
            
            dot.setAttribute('aria-label', `Vai alla slide ${slideIndex}`);
            dot.setAttribute('data-index', slideIndex); // Usa lo stesso indice della slide
    ...
    styleSheet.textContent = `
        ...
        .lookbook-indicator.active .indicator-number {
            color: #000;
        }
